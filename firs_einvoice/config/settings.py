...
class FIRSConfig(BaseSettings):
    """Main FIRS E-Invoice configuration using Pydantic Settings."""
...
class RuntimeConfig:
    ...
    def __init__(self):
        self._config: Optional[FIRSConfig] = None
    ...
    def get_config(self) -> FIRSConfig:
        ...
        if not self._config:
            self._config = FIRSConfig()
        return self._config
    
    def update_config(self, **kwargs) -> None:
        """Update configuration with new values."""
        if not self._config:
            self._config = FIRSConfig(**kwargs)
        else:
...
def update_config(**kwargs) -> None:
    ...
    get_config.cache_clear()  # Clear cache when config updates
